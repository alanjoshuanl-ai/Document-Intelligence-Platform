...
function PDFChatInterface() {
  const [schemaJson, setSchemaJson] = useState(
    JSON.stringify(
      { company_name: "", email: "", address: "", phone_number: "", date: "", language: "" },
      null,
      2
    )
  );
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 transform transition-all duration-300 hover:shadow-2xl animate-fade-in">
              ...
              <div className="w-full flex justify-center mt-4">
                ...
                >
                  {loading ? (
                    <>
                      <svg className="animate-spin -ml-1 mr极-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
